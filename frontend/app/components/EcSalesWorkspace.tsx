...
function ecSalesRecordToUpdatePayload(record: EcSalesRecord) {
  ...
  return {
    ...
    ad_fee: parseNumberLike(record.adFeeRaw),
    marketplace_fee: parseNumberLike(record.marketplaceFeeRaw),
    payout_amount: parseNumberLike(record.payoutAmountRaw),
    sale_exchange_rate: parseNumberLike(record.saleExchangeRate),
    payout_exchange_rate: parseNumberLike(record.payoutExchangeRate),
    received_amount_jpy: parseNumberLike(record.receivedAmountJpy),
    overseas_shipping_jpy: parseNumberLike(record.overseasShippingYen),
    fee_tax_refund_jpy: parseNumberLike(record.feeTaxRefundJpy),
    purchase_tax_refund_jpy: parseNumberLike(record.purchaseTaxRefundJpy),
    profit_jpy: parseNumberLike(record.profitJpy),
    profit_rate: parseNumberLike(record.profitRate),
    days_to_sell: parseNumberLike(record.daysToSell),
